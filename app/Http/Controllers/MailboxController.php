...
class MailboxController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if($request->submit == 1) {
            ...
            return redirect('admin/mailbox/Sent')->with('flash_message', 'Сообщение отправлено!');
        }
 
        return redirect('admin/mailbox/Drafts')->with('flash_message', 'Сообщение сохранено в черновик!');
    }
...
//        $folder = $mailbox->userFolder()->folder()->first();
    ...
    public function postReply(Request $request, $id)
    {
        ...
        $mailbox->subject = Str::startsWith($old_mailbox->subject, "RE:")?$old_mailbox->subject:"RE: " . $old_mailbox->subject;
        ...
        return redirect('admin/mailbox-show/' . $id)->with('flash_message', 'Ответ отправлен');
    }
