...
class DocumentsController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('pages.documents.create', compact('users'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect('admin/documents')->with('flash_message', 'Документ добавлен!');
    }
    ...
    public function edit($id)
    {
        ...
        return view('pages.documents.edit', compact('document', 'users'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect('admin/documents')->with('flash_message', 'Документ обновлен!');
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect('admin/documents')->with('flash_message', 'Документ удален!');
    }
