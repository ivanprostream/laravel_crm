...
class RolesController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect('admin/roles')->with('flash_message', 'Роль добавлена!');
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect('admin/roles')->with('flash_message', 'Роль обновлена!');
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect('admin/roles')->with('flash_message', 'Роль удалена');
    }
}
